...
export function buildCorpus(): Chunk[] {
  ...
  chunks.push({
    id: 'identity',
    source: 'profile',
    text: `${site.name} is a ${site.role}. ${site.tagline} Location: ${site.location}. Availability: ${site.availability.label}. Contact email: ${site.links.email}. LinkedIn: ${site.links.linkedin}. Typical response time: ${site.responseTime}.`,
  });
